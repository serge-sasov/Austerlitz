package ru.serge.austerlitz.items_selector;
            ...
            for(Integer index = 0; mItems.size() > index; index++) {
                ...
                itemView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        UpdateViewOutlook(((ItemView) view).getIndex());

                        //Update values
                        mSelectedIndex = ((ItemView) view).getIndex();
                        mSelectedValue = ((ItemView) view).getItem();
